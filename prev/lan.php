...
if(($_SESSION['userid']=="")||($level!= 14)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon" >
	<div class="arrow" ></div>
	<img src="img/riddle/hell_maggi.jpg"/><!---change img--->
...
<div class="balloon2" >
    ...
    <form method="post" action="lan.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1== 'octothorpe') /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{	
		$count=15;  
		$_SESSION['level']=15;	//////// change the count to relevant level
