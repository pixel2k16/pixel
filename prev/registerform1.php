...
<input name="email" type="email" value="" placeholder="email" onkeypress="this.style.width = ((this.value.length + 1) * 18) + 'px';">.<br>
    ...
    <span class="passwordRequiredMsg">A value is required.</span><span class="passwordMinCharsMsg">Minimum 5 characters</span><span class="passwordMaxCharsMsg">Maximum 15 characters</span><span class="passwordInvalidStrengthMsg">Minimum 1 uppercase and 2 digits</span></span>.<br>
