...
$result=mysql_query("select * from pixel_registration where ID ='$userid'",$con);
	while($row=mysql_fetch_array($result))
	{
		...
		{ $userid;
		 $level=$row['COUNT'];
		 echo $pass=strtolower($row['PWORD']);
		}
	}
if(($_SESSION['userid']=="")||($level!= 16)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon" >
	<div class="arrow" ></div>
	<!--<img src="img/riddle/hell_sound.jpg"/><!---change img--->
	<h1 style="text-decoration:none; color:white;">
http://goo.gl/neEFz1  =   A<br/>

http://goo.gl/2Y8gOJ  =   B<br/>

http://goo.gl/V5H90x  =  C<br/>

http://goo.gl/xb7cf3  =  D<br/>

http://goo.gl/UOwAOJ  =  E<br/>
</h1>
<center>
<h1 >A&cap;B&cap;C&cap;D&cap;E</h1>
</center>
</div>
</div>
...
<div class="balloon2" >
    ...
    <form method="post" action="hi5.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1== 'sirmychaelsmpplaylist') /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{	
		$count=17;  
		$_SESSION['level']=17;	//////// change the count to relevant level
