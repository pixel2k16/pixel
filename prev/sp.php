...
if(($_SESSION['userid']=="")||($level!= 9)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon" >
	<div class="arrow" ></div>
	<img src="img/riddle/hell_10.jpg"/><!---change img--->
...
<div class="balloon2" >
    ...
    <form method="post" action="sp.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1==$pass) /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{	
		$count=10;  
		$_SESSION['level']=10;	//////// change the count to relevant level
	$userid=$_SESSION['userid'];
	$dateon=date("d-m-y");
