...
<img src="images/level1.png" width="172"  /></p>
 <!-- edit the forum page number-->
<div style="position: absolute; right: 80px; top:381px; background: #333"> <a href="https://www.facebook.com/Riddler.pixel" target="_blank"style="position:absolute; left: -140px; top: 18px; font-size:20px; color:#FFFFFF; width: 155px;">Discussion forum</a><br>
