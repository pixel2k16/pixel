...
if(($_SESSION['userid']=="")||($level!=1)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon2" >
    ...
    <form method="post" action="cham.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1=="halloween") /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{	
		$count=2;  
		$_SESSION['level']=2;	//////// change the count to relevant level
	$userid=$_SESSION['userid'];
	$dateon=date("d-m-y");
