...
if(($_SESSION['userid']=="")||($level!= 2)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon2" >
    ...
    <form method="post" action="erl.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1=="tiger") /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{
		$count=3;  
		$_SESSION['level']=3;	//////// change the count to relevant level
	$userid=$_SESSION['userid'];
	$dateon=date("d-m-y");
