...
if(($_SESSION['userid']=="")||($level!= 6)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon" >
	<div class="arrow" ></div>
	<img src="img/riddle/hell_7.jpg"/><!---change img--->
...
<div class="balloon2" >
    ...
    <form method="post" action="mad.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1=="mormons") /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{	
		$count=7;  
		$_SESSION['level']=7;	//////// change the count to relevant level
	$userid=$_SESSION['userid'];
	$dateon=date("d-m-y");
