...
if(($_SESSION['userid']=="")||($level!= 17)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon" >
	<div class="arrow" ></div>
	<img src="img/riddle/hell_mru.jpg"/><!---change img--->
...
<div class="balloon2" >
    ...
    <form method="post" action="fb.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	{	
		$count=18;  
		$_SESSION['level']=18;	//////// change the count to relevant level
