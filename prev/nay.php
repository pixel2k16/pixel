...
setcookie("formula","P Ω V", time()+3600*24);
...
if(($_SESSION['userid']=="")||($level!= 13)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon" >
	<div class="arrow" ></div>
	<img src="img/riddle/hell_14.jpg"/><!---change img--->
...
<div class="balloon2" >
    ...
    <form method="post" action="nay.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1== 'michaeljackson') /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{	
		$count=14;  
		$_SESSION['level']=14;	//////// change the count to relevant level
	$userid=$_SESSION['userid'];
	$dateon=date("y-m-d");
