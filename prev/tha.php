...
if(($_SESSION['userid']=="")||($level!= 10)){////// 1>LEVEL NEED TO BE CHANGED/////if level 1 then write 0
head(0);
 exit;
}else{
...
<div class="balloon" >
	<div class="arrow" ></div>
	<img src="img/riddle/hell_11.png"/><!---change img--->
...
<div class="balloon2" >
    ...
    <form method="post" action="tha.php"><!---<<< 2 >>> change the action---->
...
if(isset($_POST['answer'])){		
	...
	if($answer1== 'hotpotato') /////////////// <<<<3>>>>CHANGE THE ANSWER FOR THE question
	{	
		$count=11;  
		$_SESSION['level']=11;	//////// change the count to relevant level
	$userid=$_SESSION['userid'];
	$dateon=date("d-m-y");
