...
<!--[if (gt IE 9)|!(IE)]><!--> <html lang="en" class="no-js"> <!--<![endif]-->
    <head>
        ...
        <title>PIXEL 2K16 | Register</title>
    ...
    <body>
		...
		<img class="pilogo wow fadeInDown" data-wow-delay="1s" style="display: none;" src="img/pixel.png" />
			<center><h1 class="wow slideInRight" data-wow-delay="1s">Registration</h1></center>
		</div>
		<div class="container">
				...
				$.ajax({
					...
					if(result == "yess"){
						...
						$("section.content").fadeOut("fast",function(){
							$(".on-success").append("Log in credentials were sent to your mail."
