		...
		<div class="container">			
			<section class="content">
				<form  action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
					...
					?>
					<span class="input input--kaede">
						<input class="input__field input__field--kaede" name="contactnosignup_confirm" required="required" type="text" id="input-5" maxlength="30"/>
					...
					<span class="input input--kaede">
						<input class="input__field input__field--kaede" name="colgsignup_confirm" required="required" type="text" id="input-6" maxlength="30"/>
