	...
	<div class="row">
		<div class="card-wrapper wow fadeInDown" data-wow-duration="0.5s"  data-wow-delay="0.5s">
			<div class="card">
				...
				<div class="card-details">
					<h2>Dr. S.Vasundra</h2>
					<div class="inner">
						<span class="ocp">&#128100; Convenor</span><br>
						<span class="phn">&#9742; 8466824059</span><br>
						<span class="eml">&#9993; manju.dayyala@gmail.com</span><br>
					</div>
				</div> <!-- Card details -->
			</div><!-- Card -->
		</div><!-- Card Wrapper -->
		<div class="card-wrapper wow fadeInUp" data-wow-duration="0.5s">
			<div class="card">
				...
				<div class="card-details">
					<h2>Dr. A.Suresh Babu </h2>
					<div class="inner">
						<span class="ocp">&#128100; Staff Coordinator</span><br>
						<span class="phn">&#9742; 9440388093</span><br>
						<span class="eml">&#9993; asureshjntu@gmail.com</span><br>
					</div>
				</div> <!-- Card details -->
			</div><!-- Card -->
		</div><!-- Card Wrapper -->
		...
		<div class="card-wrapper wow fadeInRight" data-wow-duration="0.5s" data-wow-delay="0.7s">
			<div class="card">
				...
				<div class="card-details">
					...
					<div class="inner">
						<span class="ocp">&#128100; Student Coordinator</span><br>
						<span class="phn">&#9742; 9393767927</span><br>
						<span class="eml">&#9993; anilkumark232@gmail.com</span><br>
					</div>
				</div> <!-- Card details -->
			</div><!-- Card -->
		</div><!-- Card Wrapper -->
