...
<body style="font-family:sans-serif;">
	<div class="content" style="background:#F5F2F2;line-height:1.4">
		...
		<div class="row" style="padding-left:10px;background:#fff;
			...
			<h2 style="font-size: 1.563rem;font-weight:normal">Hello to all vvp alumni,</h2>
			<p style="text-indent:2.188rem;">Here is some good news for you all. Something you all must be waiting for since long. It is back and better than ever. This mail comes to you as an invitation to attend PIXEL 2k16 scheduled on 19th & 20th march. We request your gracious and blessed presence at our department and make our event more successful and cherished one.</p>
			<p>
				With Love,<br>
				Team Pixel.
			</p>
